...
export const Navbar = ({ children, className }: NavbarProps) => {
  ...
  return (
    <motion.div
      ref={ref}
      className={cn("inset-x-px z-40", className)}
    >
...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "  mx-auto hidden max-w-8xl  justify-between rounded-full bg-transparent px-4 py-2 lg:flex dark:bg-transparent",
        visible && "bg-black dark:bg-gradient-to-r from-[#9945FF] to-[#20E19F]",
        className
      )}
    >
      {children}
        ...
        >
          {hovered === idx && (
            <motion.div
              ...
              className="absolute inset-0 rounded-full border border-white-400"
...
export const NavbarButton = ({
  ...
  return (
    <Tag href={href || undefined} className={cn(className)} {...props}>
      {children}
    </Tag>
  );
};
