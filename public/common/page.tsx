        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="group relative flex items-center gap-1.5 px-2.5 py-2 rounded-lg transition-all overflow-hidden">
              <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-[#9945FF] to-[#20E19F] -z-10" />
              <div className="absolute inset-[1.5px] rounded-lg bg-purple-900/30 backdrop-blur-md -z-10" />
              <div className="relative flex items-center gap-1.5 z-10">
                ...
                <span className="text-white text-xs font-normal">0x23...8374</span>
              </div>
            </button>
          </div>
        </div>
