...
export function MarketplaceBlog() {
  ...
  return (
    <section className="w-full bg-gradient-to-b from-gray-50 to-gray-100 dark:bg-transparent py-12 sm:py-20 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0 mb-10 sm:mb-14">
          ...
          <div className="inline-block rounded-xl bg-gradient-to-r from-[#7C6CFF] to-[#20E19F] p-[1.5px] w-full sm:w-auto">
            <button className="rounded-xl px-4 sm:px-6 py-2.5 sm:py-3 text-sm font-medium text-gray-900 dark:text-gray-900 bg-gradient-to-r from-[#EFEAFF] to-[#E8FFF6] hover:opacity-90 transition w-full sm:w-auto">
              Browse All Articles
            </button>
          </div>
        </div>
          ...
          {articles.map((article) => (
            ...
            >
              <div className="p-3 sm:p-4">
                <div className="w-full h-48 sm:h-64 md:h-80 rounded-lg overflow-hidden bg-gray-100">
                  <img
                    src={article.image}
                    alt={article.title}
              ...
              <div className="px-4 sm:px-6 pb-4 sm:pb-6 flex flex-col h-full">
                ...
                <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 mb-4 sm:mb-6">
                  <span>{article.author}</span>
                  <span className="mx-2 text-gray-400">|</span>
                  <span>{article.category}</span>
                </div>
                <div className="pt-3 sm:pt-4 border-t border-gray-200 flex items-center justify-between gap-2 flex-wrap">
