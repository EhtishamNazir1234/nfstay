...
export function ImmersiveSection({
  ...
  return (
    <section className="relative py-20 px-6 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-r from-purple-200 via-blue-100 to-teal-200 -z-10" />
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h2 className="text-5xl w-100 font-bold tracking-tight">
            ...
            <p className="text-lg text-gray-600 capitalize leading-relaxed  max-w-[520px]">
              {description}
            </p>
          </div>
          <div
