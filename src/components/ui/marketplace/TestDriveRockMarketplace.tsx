    ...
    <div className="flex flex-col items-center justify-center w-full">
      <div className="relative w-64 h-64 sm:w-72 sm:h-72 lg:w-80 lg:h-80 flex items-center justify-center">
        ...
        <div className="absolute flex flex-col items-center justify-center">
          ...
          <div className="text-xs text-gray-500 dark:text-gray-400 text-center font-semibold mb-6">
            Period + Rock Value
          </div>
          ...
          <div className="flex gap-6 mb-6 text-center">
            <div className="flex-shrink-0">
              ...
              <p className="text-xs text-gray-500 mt-1">APR</p>
            </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
          ...
          <div className="flex items-center pl-0 lg:pl-4 w-full sm:w-[170px] h-[22px]">
            ...
            <button
              ...
              className={`relative inline-flex w-8 h-5 items-center rounded-full transition-colors ml-[12px] ${
                boostedApr
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-[40px]">
          <div className="space-y-2 w-full">
            ...
            <div className="flex flex-col gap-[15px]">
              ...
              <div className="w-[248px] h-[38px] opacity-100 rounded-[10px] p-1 bg-gray-100 dark:bg-[#0b0f1a] flex gap-1">
                {[12, 24, 36].map((period) => (
                  <button
                    key={period}
