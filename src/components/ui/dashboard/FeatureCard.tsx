...
export default function FeatureCard({
  ...
  return (
    <div 
      className="bg-white dark:bg-[#1a1f2e] shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col"
      style={{
        width: '380px',
        height: '509px',
        borderRadius: '11px',
    ...
    >
      ...
      <div className="flex flex-col gap-4 relative">
        <div className="flex items-center justify-between py-2">
          ...
          <span 
            className="bg-gradient-to-r from-[#9945FF] to-[#20E19F] text-white text-xs font-semibold z-10 flex items-center justify-center px-3 py-2"
            style={{
              height: '32px',
              borderRadius: '7px',
            }}
